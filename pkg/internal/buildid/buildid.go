...
import (
	...
	"github.com/mdempsky/gocode/pkg/internal/xcoff"
)
...
// Read reads the build ID from an archive or executable file.
func Read(name string, f *os.File) (id string, err error) {
	buf := make([]byte, 8)
